...
const GEMINI_API_KEY = "AIzaSyB-wGfQXejIjogGCzjppc-rDm8SIFYNvzM";
    ...
    <div className="idea-container">
      <div className="idea-header">
        ...
        <p className="idea-subtitle">
          Transform your challenges into opportunities with advanced AI
          assistance
        </p>
        <div className="ai-status">
          ...
          <span className="ai-status-text">
            AI System Confidence: {aiConfidence}%
          </span>
        </div>
      </div>
            ...
            {generatedIdeas.map((idea) => (
              <div key={idea.id} className="idea-card">
                <div className="idea-card-header">
                  ...
                  <span className="idea-confidence">
