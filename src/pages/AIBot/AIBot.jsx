// components/AIBot/AIBot.jsx
import React, { useState, useRef, useEffect } from "react";
import "./AIBot.css";

const PERPLEXITY_API_KEY =
  "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";
...
const AIBot = ({ isOpen, toggleAIBot }) => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      // Using the same format as your other components
      const response = await fetch(
        "https://api.perplexity.ai/chat/completions",
        {
          ...
          body: JSON.stringify({
            model: "sonar-small-chat", // Using a smaller model for chat
            messages: [
              {
                role: "system",
                content:
